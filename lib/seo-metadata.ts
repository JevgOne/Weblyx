...
const seoContent: Record<Locale, SEOContent> = {
  ...
  de: {
    title: 'Website erstellen lassen | Festpreis ab 349€ | Seitelyx',
    titleTemplate: '%s | Seitelyx',
    description: 'Website erstellen lassen ab 349€ Festpreis. 3× schneller als WordPress, Lieferung in 3-7 Tagen, DSGVO-konform. Webdesign Agentur für moderne Next.js Websites ohne monatliche Kosten.',
    keywords: [
