...
const seoContent: Record<Locale, SEOContent> = {
  cs: {
    ...
    ogTitle: 'Tvorba webových stránek od 10 000 Kč | Web za týden',
    ogDescription: 'Rychlá tvorba webů od 10 000 Kč (AKCE 7 990 Kč). Web za týden, načítání pod 2s, SEO zdarma.',
    twitterTitle: 'Tvorba webových stránek od 10 000 Kč | Web za týden',
    twitterDescription: 'Rychlá tvorba webů od 10 000 Kč (AKCE 7 990 Kč). Web za týden, načítání pod 2s, SEO zdarma.',
    locale: 'cs_CZ',
    alternateLang: 'de',
  ...
  de: {
    ...
    description: 'Schnelle Webseitenerstellung ab 249€ (ANGEBOT 199€). Website in einer Woche, Ladezeit unter 2s, SEO inklusive. Kostenlose unverbindliche Beratung.',
    keywords: [
      'Webseitenerstellung',
      'Website erstellen',
      'Website Kosten',
    ...
    ogTitle: 'Webseitenerstellung ab 249€ | Website in einer Woche',
    ogDescription: 'Schnelle Webseitenerstellung ab 249€ (ANGEBOT 199€). Website in einer Woche, Ladezeit unter 2s, SEO inklusive.',
    twitterTitle: 'Webseitenerstellung ab 249€ | Website in einer Woche',
    twitterDescription: 'Schnelle Webseitenerstellung ab 249€ (ANGEBOT 199€). Website in einer Woche, Ladezeit unter 2s, SEO inklusive.',
    locale: 'de_DE',
    alternateLang: 'cs',
