...
const content = `WordPress pohání zhruba 40 % všech webů na internetu. Tahle čísla znáš — opakuje je každý druhý článek o tvorbě webů. Ale víš, co ti tyhle články neřeknou? Že většina těch webů je pomalá, děravá a majitele stojí víc peněz, než si myslí.
...
Sečteno podtrženo: **10 000 až 50 000 Kč ročně** za web, který je pořád pomalejší než by měl být. A to nepočítám tu prvotní tvorbu.
...
Nebo — a to je náš přístup u Weblyx — ti prostě nastavíme správu obsahu přesně na míru. Žádné desítky tlačítek, která nepotřebuješ. Jen to, co reálně používáš.
...
Firemní prezentace, portfolio služeb, kontaktní formulář, maybe blog. To je 80 % toho, co potřebuješ. A na to je Next.js *dokonalý*.
...
Chceš vědět, jak by vypadal tvůj nový web? Bez závazků, bez bullshitu. Prostě se ozvi a řekneme ti, co pro tebe dává smysl.

👉 [Poslat poptávku](/poptavka)`;

async function main() {
  console.log('📝 Publishing first blog article...\n');

  try {
    const post = await createBlogPost({
      title: 'WordPress je mrtvý a vaše agentura vám to neřekne',
      slug: 'wordpress-vs-nextjs-srovnani-2026',
      content,
      excerpt: 'WordPress pohání 40 % internetu, ale je to ještě správná volba pro malou firmu v roce 2026? Upřímné srovnání s Next.js — rychlost, bezpečnost, cena a údržba. Bez bullshitu.',
      authorName: 'Weblyx Team',
      published: true,
      publishedAt: new Date(),
      tags: ['WordPress', 'Next.js', 'srovnání', 'tvorba webu', 'rychlost webu', 'SEO'],
      metaTitle: 'WordPress vs Next.js — upřímné srovnání pro podnikatele (2026)',
      metaDescription: 'WordPress pohání 40% internetu, ale je to ještě správná volba? Srovnáváme rychlost, bezpečnost, cenu a údržbu. Bez bullshitu.',
      language: 'cs',
      autoTranslate: false,
    });
    ...
    console.log(`\n🔗 URL: https://www.weblyx.cz/blog/${post.slug}`);
  } catch (error) {
