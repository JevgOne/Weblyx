...
const FAQS = [
  {
    ...
    answer:
      "Webové stránky pro advokáty začínají od 7 990 Kč. Web s klientským portálem a online objednávkami je nad rámec balíčků, cenu připravíme na poptávku. V ceně je vždy design na míru, SEO optimalizace, GDPR soulad a mobilní responzivita.",
  },
  {
...
export default function WebProPravnikyPage() {
  ...
  const webpageSchema = generateWebPageSchema({
    ...
    description: "Profesionální webové stránky pro advokáty a advokátní kanceláře od 7 990 Kč.",
    url: "https://www.weblyx.cz/web-pro-pravniky",
    breadcrumbs,
  });
        ...
        <section className="py-16 md:py-24 px-4 bg-gradient-to-b from-background to-muted/20">
          <div className="container mx-auto max-w-5xl text-center space-y-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              ...
              Klientský portál, online objednávky, GDPR soulad. Od <strong>7 990 Kč</strong> s{" "}
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto mt-10">
              ...
              <Card className="border-2 border-primary/60 shadow-xl transition-all hover:shadow-2xl">
                <CardHeader className="space-y-2 text-center">
                  ...
                  <p className="text-3xl font-black text-primary">Na poptávku</p>
                </CardHeader>
                <CardContent className="space-y-3">
                  <ul className="space-y-2 text-left">
