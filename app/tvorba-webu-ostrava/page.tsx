...
const FAQS = [
  {
    ...
    answer:
      "Profesionální web pro ostravskou firmu pořídíte od 7 990 Kč. Za tuto cenu dostanete moderní responzivní design, SEO optimalizaci, rychlé načítání a podporu po spuštění (1–3 měsíce podle balíčku). Oproti ostravským agenturám nabízíme technologicky pokročilejší řešení za srovnatelnou nebo nižší cenu.",
  },
  {
    question:
