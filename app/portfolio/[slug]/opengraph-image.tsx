...
import { getPortfolioById } from '@/lib/turso/portfolio';

// Route segment config
export const runtime = 'edge';

// Image metadata
export const alt = 'Weblyx Portfolio';
export const size = {
  width: 1200,
  height: 630,
};
      ...
      (
        ...
        >
          ...
          >
            ...
            >
              💼 Portfolio {project.category ? `• ${project.category}` : ''}
            </div>
            ...
            {/* Performance Stats */}
            {(project.pagespeedMobile || project.loadTimeAfter) && (
              <div
                style={{
                  display: 'flex',
                  gap: '24px',
              ...
              >
                {project.pagespeedMobile && (
                  ...
                  >
                    <div style={{ fontSize: '18px', color: '#94a3b8' }}>PageSpeed</div>
                ...
                {project.loadTimeAfter && (
                  ...
                  >
                    <div style={{ fontSize: '18px', color: '#94a3b8' }}>Načítání</div>
                    <div style={{ fontSize: '36px', fontWeight: 'bold', color: '#14B8A6' }}>
                      {project.loadTimeAfter}s
                    </div>
                  </div>
                )}
              </div>
